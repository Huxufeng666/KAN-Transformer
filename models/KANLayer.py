...
class KANLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        (torch.Size([100, 5]),
         ...
         torch.Size([100, 5, 3]))
        '''
        # print('grid shape: ', self.grid.shape, self.grid[self.weight_sharing].shape)
        batch = x.shape[0]
        ...
        # print('multiplication output shape: ', y.shape)
        y = y.permute(1, 0)  # shape (batch, size)
        # print('multiplication permuted output shape: ', y.shape)
        ...
        # print('Expected input/output dim: ', self.in_dim, self.out_dim)
