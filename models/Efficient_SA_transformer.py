...
class Attention(nn.Module):
    def __init__(self,
        ...
        # self.attention = Grouped_KA_attention(out_dim = self.num_patches+1, patches = (self.num_patches+1), heads = self.num_heads, head_dim = head_dim, groups = 32)
    ...
    def forward(self, x):
        ...
        # print('== input q, k shapes: ', q.shape, k.shape)
...
def Eit_base_patch16_224(num_classes: int = 1000):
    """
