...
def B_batch(x, grid, k=0, extend=True, device='cpu'):
    ...
    if k == 0:
        # print('*** grid shapes: ', grid[:, :-1].shape, ' ', grid[:, 1:].shape)
        ...
        # print('*** value out shape: ', value.shape)
    return value
...
def coef2curve(x_eval, grid, coef, k, device="cpu"):
    ...
    # print('basis input shape: ', x_eval.shape)
    # print('coefficient shape: ', coef.shape)
    # print('basis output shape: ', B_batch(x_eval, grid, k, device=device).shape)
